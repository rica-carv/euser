...
INTRODUCTION:
===============
This plugin includes several original outdated plugins not working on E107 v2, combined and upgraded to work with v2, as follows:

- e107 Another profiles plugin, 0.9.8 Beta verzio UTF-8 es ISO (2012.10.23), by Istvan Csonka (http://freedigital.hu)
- Online Info menu plugin, version 8.5.2, by TheMadMonk (http://www.gamingmad.com)
...
DISCLAIMER:
===============
Euser Plugin comes with ABSOLUTELY NO WARRANTY
