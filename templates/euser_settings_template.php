...
$EUSER_SETTINGS_WRAPPER['edit']['DELETEACCOUNTBUTTON']			= '<div class="float-end">{---}</div>';
	...
	<div class="fw-bolder p-2 pt-4">{LAN=LAN_EUSER_110} - {LAN=LAN_EUSER_121}</div>
	<div class="form-group row align-items-center">
	<label for="infovis" class="col-sm-3 control-label border-0">{LAN=LAN_EUSER_112}</label>
	<div class="col-sm-9 border-0">{---}</div></div>';
	$EUSER_SETTINGS_WRAPPER['edit']['EUSER_PROFRIENDS']			= '
	<div class="fw-bolder p-2 pt-4">{LAN=LAN_EUSER_110} - {LAN=LAN_EUSER_130}</div>
	<div class="form-group row align-items-center">
	<label for="friendvis" class="col-sm-3 control-label border-0">{LAN=LAN_EUSER_113}</label>
	<div class="col-sm-9 border-0">{---}</div></div>';
	$EUSER_SETTINGS_WRAPPER['edit']['EUSER_PMONFRIEND']			= '
	<div class="form-group row align-items-center">
	<label for="pmfriend" class="col-sm-6 control-label border-0">{LAN=LAN_EUSER_122}</label>
	<div class="col-sm-6 border-0">{---}</div></div>';
	$EUSER_SETTINGS_WRAPPER['edit']['EUSER_EMAILONFRIEND']			= '
	<div class="form-group row align-items-center">
	<label for="emfriend" class="col-sm-6 control-label border-0">{LAN=LAN_EUSER_123}</label>
	<div class="col-sm-6 border-0">{---}</div></div>';
	$EUSER_SETTINGS_WRAPPER['edit']['EUSER_SHOWFRIENDBUTTON']			= '
	<div class="form-group row align-items-center">
	<label for="showfrbut" class="col-sm-6 control-label border-0">{LAN=LAN_EUSER_124}</label>
	<div class="col-sm-6 border-0">{---}</div></div>';
	$EUSER_SETTINGS_WRAPPER['edit']['EUSER_PROCOMMWATCH']			= '
	<div class="form-group row align-items-center">
	<label for="prcommvis" class="col-sm-3 control-label border-0">{LAN=LAN_EUSER_114}</label>
	<div class="col-sm-9 border-0">{---}</div></div>';
	$EUSER_SETTINGS_WRAPPER['edit']['EUSER_PROCOMM']			= '	<div class="form-group row align-items-center">
	<label for="prcom" class="col-sm-3 control-label border-0">{LAN=LAN_EUSER_115}</label>
	<div class="col-sm-9 border-0">{---}</div></div>';
	$EUSER_SETTINGS_WRAPPER['edit']['EUSER_PROPICWATCH']			= '
	<div class="fw-bolder p-2 pt-4">{LAN=LAN_EUSER_110} - {LAN=LAN_EUSER_140}</div>
	<div class="form-group row align-items-center">
	<label for="primgvis" class="col-sm-3 control-label border-0">{LAN=LAN_EUSER_116}</label>
	<div class="col-sm-9 border-0">{---}</div></div>';
	$EUSER_SETTINGS_WRAPPER['edit']['EUSER_PROPICCOMM']			= '	<div class="form-group row align-items-center">
	<label for="primgcom" class="col-sm-3 control-label border-0">{LAN=LAN_EUSER_117}</label>
	<div class="col-sm-9 border-0">{---}</div></div>';
	$EUSER_SETTINGS_WRAPPER['edit']['EUSER_PROVIDWATCH']			= '
	<div class="fw-bolder p-2 pt-4">{LAN=LAN_EUSER_110} - {LAN=LAN_EUSER_150}</div>
	<div class="form-group row align-items-center">
	<label for="prvidvis" class="col-sm-3 control-label border-0">{LAN=LAN_EUSER_118}</label>
	<div class="col-sm-9 border-0">{---}</div></div>';
	$EUSER_SETTINGS_WRAPPER['edit']['EUSER_PROVIDCOMM']			= '	<div class="form-group row align-items-center">
	<label for="prvidcom" class="col-sm-3 control-label border-0">{LAN=LAN_EUSER_119}</label>
	<div class="col-sm-9 border-0">{---}</div></div>';
	$EUSER_SETTINGS_WRAPPER['edit']['EUSER_PROMP3']			= '	<div class="form-group row align-items-center">
	<label for="prmp3vis" class="col-sm-3 control-label border-0">{LAN=LAN_EUSER_120}</label>
	<div class="col-sm-9 border-0">{---}<div class="d-inline-flex ms-4">
	{EUSER_MP3_SET}
	</div></div></div>';
	$EUSER_SETTINGS_WRAPPER['edit']['EUSER_PROFILE_STATS']			= '	<div class="fw-bolder p-2 pt-4">{LAN=LAN_EUSER_111}</div>
...
{EUSER_WARN}
<div class="euser-edit_profile row">
    <div class="col-md-12">
	    <div class="panel panel-default panel-profile">
	      	<div class="panel-body">
	        	<div class="row border-0">
                  ...
                  <div class="card with-nav-tabs bg-success">
                  <div class="card-header pb-0">
                	    			<ul class="nav nav-tabs" role="tablist">
		                    			<li><a class="tab-home active nav-link" data-bs-toggle="tab" href="#euser-home" data-bs-toggle="tab" href="#euser-settings" data-bs-original-title="{LAN=PROFILE_185}" title="{LAN=PROFILE_185}">{LAN=LAN_418}</a></li>
	        		              		<li><a class="tab-euser-social nav-link" data-bs-toggle="tab" href="#euser-social">{LAN=LAN_EUSER_1}</a></li>
										{EUSER_FRIENDS_EDIT:caption}
        	              				{EUSER_IMAGES_EDIT:caption}
		    	                  		{EUSER_VIDEOS_EDIT:caption}
	        		              		<li><a class="tab-euser-settings nav-link" data-bs-toggle="tab" href="#euser-settings" data-bs-original-title="{LAN=PROFILE_170}" title="{LAN=PROFILE_170}">{LAN=LAN_EUSER_102}</a></li>
	    			                </ul>
                    </div>
...
<button type="button" class="btn btn-default" data-bs-toggle="modal" data-bs-target="#MP3Modal">{LAN=LAN_EUSER_103}
</button>
<!-- Modal -->
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="MP3ModalLabel">{LAN=LAN_EUSER_103}</h1>
...
$EUSER_SETTINGS_TEMPLATE['edit_caption'] = LAN_EUSER_101."&nbsp;{USER_NAME}";
