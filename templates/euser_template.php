...
$EUSER_WRAPPER['main']['USER_EXTENDED_ALL'] = "<tr><td class='forumheader3 left'>{---}</td></tr>";
/*
...
$EUSER_WRAPPER['main']['EUSER_FRIENDS:'] = "<div id='euser-friends' class='tab-pane fade card-body'>{---}</div>";
$EUSER_WRAPPER['main']['EUSER_IMAGES:'] = "<div id='euser-images' class='tab-pane fade card-body'>{---}</div>";
$EUSER_WRAPPER['main']['EUSER_VIDEOS:'] = "<div id='euser-videos' class='tab-pane fade card-body'>{---}</div>";


//$EUSER_WRAPPER['main']['EUSER_COMMENTS:'] = "<div id='euser_comments' class='tab-pane fade card-body'>{---}</div>";
$EUSER_WRAPPER['main']['PROFILE_COMMENTS'] = "<div id='euser_comments' class='tab-pane fade card-body'>{---}</div>";
...
$EUSER_TEMPLATE['extended']['start'] = '<div class="d-flex row rows-col-2 ">';
$EUSER_TEMPLATE['extended']['end']   = '</div>';

$EUSER_TEMPLATE['extended']['item'] = '
