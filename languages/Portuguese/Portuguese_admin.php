...
define("EUSER_LOGIN_MENU_A58", "Cor de borde do Pop up da info de usuário: "); 
define("EUSER_LOGIN_MENU_A59", "Cor de fundo do Pop up da info de usuário: "); 
...
define("EUSER_LOGIN_MENU_A187", "Utilização de cor na classe de usuário (Admin Geral, Admin e Moderador - Omitir estes)"); 
define("EUSER_LOGIN_MENU_A188", "Classe de Usuário (Descrição)"); 
