...
/*
+---------------------------------------------------------------+
| Another Profiles Plugin v0.9.3
...
*/
// ADMIN LAN
define("AP_ADMIN_1", "Another profiles- a versão extendida dos perfis de utilizador do sistema e107, que possibilita aos membros adicionar amigos, partilhar videos, ter a sua própria música, etc. ...");
define("AP_ADMIN_2", "Configurações Another Profiles");

define("LAN_ADMIN_5", "Standard"); 
