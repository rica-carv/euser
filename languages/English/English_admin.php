...
define("LAN_EUSER_ADMIN_659", "AIM");    // Endere�o AIM
define("LAN_EUSER_ADMIN_660", "ICQ");    // N�mero ICQ
define("LAN_EUSER_ADMIN_661", "MSN");    // Endere�o MSN
define("LAN_EUSER_ADMIN_662", "Yahoo");    // Endere�o Yahoo

// H� aqui muitas LANS que est�o no core... Troca-se? n�o...

// Passar para o config do menu PM
// C�digo do admin   . Tenho de ir � pesca da fun��o   Create_sound_dropdown
/*
<tr>
...
// N�o usados no config, passou a ser definido via template...
