...
include(e_PLUGIN.'euser/plugin.php');

$text ='<script type="text/javascript" src="'.e_PLUGIN.'euser/switchcontent.js"></script>';

//$text .= '<center><strong><img src="'.e_PLUGIN.'euser/images/logo.png"><br />'.ONLINEINFO_HELP_1.': '.$eplug_version.'</strong></center>';
//$text .= '<hr />';
...
$text .= '<a href="'.e_SELF.'?sysinfo">'.ADMIN_PROFILE_104.'</a>';
...
$text.='</table>';
    ...
    $text.='<script type="text/javascript">
		...
		showhide.setPersist('.$euser_pref["onlineinfo_rememberbuttons"].')
		showhide.init()
</script>';


/*
  $text .='<table class="fborder"><tr><td style="font-weight:bold; text-align:center;" colspan="2">'.EUSER_LOGIN_MENU_A60.'</td></tr>';
...
if ($ispminstalled==1){
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/tick.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A84.EUSER_LOGIN_MENU_A78.'</td></tr>';
}else{
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A84.EUSER_LOGIN_MENU_A79.'&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A84.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
}

if ($iscopperinstalled==1){
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/tick.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A82.EUSER_LOGIN_MENU_A78.'</td></tr>';
}else{
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A82.EUSER_LOGIN_MENU_A79.'&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A82.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
}

if ($isloginstalled==1){
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/tick.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A85.EUSER_LOGIN_MENU_A78.'</td></tr>';
}else{
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A85.EUSER_LOGIN_MENU_A79.'&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A85.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
}

if ($euser_pref["statActivate"]==1){
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/tick.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A85.EUSER_LOGIN_MENU_A80.'</td></tr>';
}else{
	if ($isloginstalled==1){
	$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;"><a href="'.e_PLUGIN.'log/admin_config.php">'.EUSER_LOGIN_MENU_A85.EUSER_LOGIN_MENU_A81.'</a>&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A85.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
	}else{
	$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A85.EUSER_LOGIN_MENU_A81.'&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A85.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
	}
}


if ($isguestbookinstalled==1){
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/tick.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A83.EUSER_LOGIN_MENU_A78.'</td></tr>';
}else{
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A83.EUSER_LOGIN_MENU_A79.'&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A83.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
}

if ($isforuminstalled==1){
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/tick.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A86.EUSER_LOGIN_MENU_A78.'</td></tr>';
}else{
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A86.EUSER_LOGIN_MENU_A79.'&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A86.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
}

if ($euser_pref["track_online"]==1){
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/tick.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A87.EUSER_LOGIN_MENU_A80.'</td></tr>';
}else{
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;"><a href="'.e_ADMIN.'users.php?options">'.EUSER_LOGIN_MENU_A87.EUSER_LOGIN_MENU_A81.'</a>&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A87.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
}

if ($euser_pref["profile_rate"]==1){
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/tick.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A88.EUSER_LOGIN_MENU_A80.'</td></tr>';
}else{
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;"><a href="'.e_ADMIN.'users.php?options">'.EUSER_LOGIN_MENU_A88.EUSER_LOGIN_MENU_A81.'</a>&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A88.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
}


if ($islistinstalled==1){
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/tick.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A106.EUSER_LOGIN_MENU_A78.'</td></tr>';
}else{
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A106.EUSER_LOGIN_MENU_A79.'&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A106.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
}

if ($isdeletemeinstalled==1){
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/tick.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A150.EUSER_LOGIN_MENU_A78.'</td></tr>';
}else{
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A150.EUSER_LOGIN_MENU_A79.'&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A150.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
}



if ($isyoutubeinstalled==1){
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/tick.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A151.EUSER_LOGIN_MENU_A78.'</td></tr>';
}else{
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A151.EUSER_LOGIN_MENU_A79.'&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A151.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
}

if ($iskroozearcadeinstalled==1){
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/tick.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A164.EUSER_LOGIN_MENU_A78.'</td></tr>';
}else{
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A164.EUSER_LOGIN_MENU_A79.'&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A164.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
}


if ($islinkpageinstalled==1){
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/tick.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A168.EUSER_LOGIN_MENU_A78.'</td></tr>';
}else{
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A168.EUSER_LOGIN_MENU_A79.'&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A168.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
}


if ($isbugtracker3installed==1){
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/tick.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A175.EUSER_LOGIN_MENU_A78.'</td></tr>';
}else{
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A175.EUSER_LOGIN_MENU_A79.'&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A175.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
}

if ($ischatboxinstalled==1){
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/tick.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A180.EUSER_LOGIN_MENU_A78.'</td></tr>';
}else{
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A180.EUSER_LOGIN_MENU_A79.'&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A180.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
}

if ($ischatboxIIinstalled==1){
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/tick.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A181.EUSER_LOGIN_MENU_A78.'</td></tr>';
}else{
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A181.EUSER_LOGIN_MENU_A79.'&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A181.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
}


if ($isjokeinstalled==1){
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/tick.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A193.EUSER_LOGIN_MENU_A78.'</td></tr>';
}else{
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A193.EUSER_LOGIN_MENU_A79.'&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A193.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
}

if ($isbloginstalled==1){
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/tick.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A195.EUSER_LOGIN_MENU_A78.'</td></tr>';
}else{
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A195.EUSER_LOGIN_MENU_A79.'&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A195.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
}

if ($issuggestioninstalled==1){
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/tick.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A197.EUSER_LOGIN_MENU_A78.'</td></tr>';
}else{
$text .='<tr><td style="text-align:center;"><img src="'.e_PLUGIN.'euser/images/cross.png"></td><td style="vertical-align: middle;">'.EUSER_LOGIN_MENU_A197.EUSER_LOGIN_MENU_A79.'&nbsp;(&nbsp;'.EUSER_LOGIN_MENU_A197.EUSER_LOGIN_MENU_A103.'&nbsp;)</td></tr>';
}
