...
//---- }
	...
	$sc = e107::getScBatch('stats', 'euser');
...
//    var_dump ($EXTRAINFO_MENU_TEMPLATE['main']);
  $template = e107::getTemplate('euser', 'stats_menu');
//    var_dump ($template['main']);
//    var_dump ($EXTRAINFO_MENU_TEMPLATE['main']);
//	$sc = e107::getScBatch('stats_menu', 'euser');
...
if(!defined('IMAGE_new'))
{
	...
	$ns->tablerender(LAN_EUSER_2014, $text, 'euser_stats_menu');
