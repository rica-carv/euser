  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="AvatarModalLabel">'.EUSERPROFILE_110.'</h1>
...
/*
		...
		echo "</pre>";
*/
//		$options[1]['label'] = EUSERPROFILE_130;
//		$options[2]['label'] = EUSERPROFILE_131;
...
/*
		...
		($this->var['euser_pref']['friends']?e107::getForm()->checkbox($name.'_fr', 0, $this->euser_privprefs[$name.'_fr'], array('label' => EUSERPROFILE_130)).
		"</span><span class='ps-2'>":"").
		e107::getForm()->checkbox($name.'_us', 0, $this->euser_privprefs[$name.'_us'], array('label' => EUSERPROFILE_131)).
		"</span><span class='ps-2'>".
		e107::getForm()->checkbox($name, 0, $this->euser_privprefs[$name], array('label' => EUSERPROFILE_132)).
		"</span>"."</div>":null;
*/
		return ($this->var['euser_pref'][$var])?"<div class='d-inline-flex'>"."<span>".
		($this->var['euser_pref']['friends']?e107::getForm()->checkbox('eprefs[]', '+'.$this->flags[$name.'_fr'], $this->euser_privprefs[$name.'_fr'], array('label' => EUSERPROFILE_130)).
		"</span><span class='ps-2'>":"").
		e107::getForm()->checkbox('eprefs[]', '+'.$this->flags[$name.'_us'], $this->euser_privprefs[$name.'_us'], array('label' => EUSERPROFILE_131)).
		"</span><span class='ps-2'>".
		e107::getForm()->checkbox('eprefs[]', '+'.$this->flags[$name], $this->euser_privprefs[$name], array('label' => EUSERPROFILE_132)).
		"</span>"."</div>":null;
	}
...
//		$currentmp3 = " ".PROFILE_158." ".str_replace("_", " ", $mp3file);
	...
	{
//			return $this->var['euser_pref']['friends']?"<span>".e107::getForm()->checkbox("pmfriend", 1, false, array('label' => EUSERPROFILE_22))."</span><span class='ps-2'>":null;
...
//			$this->render_checkboxes("pmfriend", "friends");
	...
	{
//		return $this->var['euser_pref']['friends']?"<span>".e107::getForm()->checkbox("emfriend", 1, false, array('label' => EUSERPROFILE_23))."</span><span class='ps-2'>":null;
...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#MP3Modal">'.EUSERPROFILE_103.'
</button>';
*/
// MAX_MP3_FILESIZE
/*
...
<div id="MP3Modal" class="modal fade " tabindex="-1" aria-labelledby="MP3ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="MP3ModalLabel">'.EUSERPROFILE_103.'</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
';
...
/*
	function sc_euser_del_avatar($parm){
		return e107::getForm()->checkbox('setavatar', 1, false, array('label' => EUSERPROFILE_110));
