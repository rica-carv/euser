...
*/
		...
		$edata = array(
			...
			'links' => array ('label'=>EUSERPROFILE_3,'title'=>PROFILE_37,'table'=>'links_page','count_field'=>'link_author', 'count_data'=>$this->var['user_id']),
			...
			'forum' => array ('label'=>EUSERPROFILE_5,'title'=>PROFILE_213,'table'=>'forum_post','count_field'=>'post_user', 'count_data'=>$this->var['user_id']),
			'chatbox_menu' => array ('label'=>LAN_PLUGIN_CHATBOX_MENU_NAME,'title'=>PROFILE_23,'table'=>'chatbox','count_field'=>'cb_nick', 'count_data'=>$this->var['user_name']),
		);
//		Falta o chatbox
//		$captions = '';	
/*
